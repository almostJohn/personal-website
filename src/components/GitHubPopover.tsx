				...
				<div className="flex flex-col gap-4">
					...
					<div className="flex flex-col gap-2">
						...
						<a
							...
							rel="noreferrer"
							target="_blank"
							className="inline-flex items-center justify-center gap-2 rounded border border-neutral-300 px-4 py-2 text-sm font-medium whitespace-nowrap transition-colors hover:bg-neutral-200"
						>
							Repositories
						</a>
					</div>
